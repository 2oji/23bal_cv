...
Highly analytical skills and impactful innovation in complex Linux-based systems and hardware bring-up. Leveraging deep functional knowledge across device drivers, bootloaders, network protocols and strong debugging skills.%
\newline%
Excelled at resolving critical complex issues, feature development, analyzing complex bugs, customer scenarios and optimizing existing embedded framework.%
\newline%
Strategically execute projects to deliver robust, high-performance embedded solutions and drive timely, customer-centric outcomes.
\newline%
My clear communication and collaborative teamwork approach ensure seamless engagement with stakeholders, customers, and cross-functional teams, while actively contributing to the coaching and development of junior engineers.%
\vspace{7pt}%
}
%
%
