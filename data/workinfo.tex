...
\indent\begin{tabularx}{\textwidth}{p{0.30\textwidth} p{\RIGHTCOLUMNWIDTH}} % Total width = \linewidth. Mix of types.
%    \hline
 Responsible for the whole embedded system, from understanding customer requirements, developing feature, resolving bugs/issues and end-to-end validations.
 Resolved numerous complex issues while porting and in the bring-up phase in u-boot, linux kernel and system level applications.
    ...
    % Remove any vertical spaced added by itemsep
    \footnotesize {
          \item \noindent Board Bring UP of multiple targets like TI's DM388, Qualcomm, TDA2xx and Freescale i.MX6 series.
          \item \noindent Porting of u-boot, linux kernel, device-tree \& System level applications.
          \item \noindent Implemented IPC's, Multi thread and Socket Programming.
          \item \noindent Written applications for hostapd, udhcpc, wpa\_supplicant, nodejs, boa server to meet use-cases.
          \item \noindent Linux device driver to configure HOST DM388 in slave mode over I2C \& SPI bus.
          \item \noindent Experienced with Embedded protocols like I2C, SPI, Ethernet, MDIO, Router, Bluetooth, DDR and integrating memories i.e. NAND, eMMC with Host controller.
    }
   \end{myitemize}\vspace{-\topsep}%
\end{tabularx}
\endgroup
