...
\footnotesize {
   \item \noindent \textbf{UFS - Boot KPI} improvements \textemdash{} by 200msec \\
      \BAspaceBullet UFS partial Init               \BAspaceBullet XBL - Skip UFS PHY settings    \BAspaceBullet Remove retry of UFS2.x \\
      \BAspaceBullet Remove read in PWM Gear        \BAspaceBullet UFS read increased to 256MB data   \\
      \BAspaceBullet UFS \textbf{Scatter-Gather}    \BAspaceBullet PMIC init parallel to UFS
