...
%  Page 1 - Right Column - Frame 1
%  Static frame
\newstaticframe[1]{\RIGHTCOLUMNWIDTH}{\textheight}{\SIDEBYSIDEGAP}{0pt}[right]
%  Page 1 - Left column - Frame 2
\newflowframe[1]{\LEFTCOLUMNWIDTH}{\textheight}{0pt}{0pt}[left]
%  Page 2 & onwards - Full page - Frame 3
...
\setstaticframe{1}{backcolor=green}
